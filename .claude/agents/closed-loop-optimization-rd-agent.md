...
model: opus
tools: Read, Write, Edit, MultiEdit, Bash, Glob, Grep, LS, WebFetch, WebSearch, NotebookRead, NotebookEdit, TodoWrite, Skill, Agent, SendMessage, TeamCreate, TeamDelete
color: yellow
---
